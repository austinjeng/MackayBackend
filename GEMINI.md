# Please carefully read the information below before every time you answer
...
## Before you answer
- Make sure to check the complete project structure is stable and logical, if not, raise your concerns. For example, if you change a page that would affect another page, check that effected page and see if any adjustments are needed. 
